<fieldset class="gauche"><legend><h3>Infos presonnelles</h3></legend>
	<label for="pseudoID">Pseudo </label><input type="text" size="20" id="pseudoID" name="login" onkeyup="verifLogin()" value="<?php echo $_POST['login'] ?>" required/><br/>

	<label for="prenomID">Name </label><input type="text" size="20" id="prenomID" name="prenom" onkeyup="verifPrenom()" value="<?php echo $_POST['prenom'] ?>" required/><br/>
	
	<label for="nomID">Last name </label><input type="text" size="20" id="nomID" name="nom" onkeyup="verifNom()" value="<?php echo $_POST['nom'] ?>" required/><br/>
...
<fieldset class="bas"><legend><h3>Contact</h3></legend>
	<label for="telID">Phone number </label><input type="tel" size="20" id="telID" name="tel" onkeyup="verifTelephone()" value="<?php echo $_POST['tel'] ?>" required/><br/>

	<label for="mailID">E-mail </label><input type="text" size="20" id="mailID" name="mail" onkeyup="verifMail()" value="<?php echo $_POST['mail'] ?>" required/>
